...
public class AsfRequestMapper {
    ...
    public void toPersonnel(
            AsfPersonnelRequest request,
    ...
    public void toSpecialists(
            AsfSpecialistsRequest request,
    ...
    public List<AsfSigner> toSigners(
            List<AsfSignerRequest> requests
    ) {
    ...
    private AsfSigner toSigner(
            AsfSignerRequest request
    ) {
    ...
    public List<AsfWorkType> toWorkTypes(
            List<AsfWorkTypeRequest> requests
    ) {
    ...
    private AsfWorkType toWorkType(
            AsfWorkTypeRequest request
    ) {
    ...
    public List<AsfDocumentImage> toImages(
            List<AsfImageRequest> requests
    ) {
    ...
    private AsfDocumentImage toImage(
            AsfImageRequest request
    ) {
